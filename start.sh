...
if [ "$START_DOCKER" = true ]; then
    ...
    chmod 777 "$PROJECT_ROOT/Talishar/Games" 2>/dev/null || true
    chmod -R 777 "$PROJECT_ROOT/Talishar/HostFiles" "$PROJECT_ROOT/Talishar/AccountFiles" "$PROJECT_ROOT/Talishar/APIKeys" 2>/dev/null || true
